...
# import meshedmemorytransformermaster.meshedm2transformer.models.transformer
from .m2.m2transformer.models.transformer import Transformer, MemoryAugmentedEncoder, MeshedDecoder, ScaledDotProductAttentionMemory
# from meshedmemorytransformermaster.meshedm2transformer.models.transformer import Transformer, MemoryAugmentedEncoder, MeshedDecoder, ScaledDotProductAttentionMemory
...
class M2TransformerModel_local(TransformerModel):
    ...
    def __init__(self, opt):
        super(M2TransformerModel_local, self).__init__(opt)
        # print('__init__ func of M2Transformer_local Model is running')
